...
<%@include file="../partials/header.html" %>
	<form action="../update" method="post">
		...
		<span>Contact Number</span><input type="text" name="contactNo" value="${employee.contactNo}"
			required /><br> 
			<span>Email Id</span><input type="text"
			name="email" required value="${employee.email}" /><br> <input type="submit" value="submit">
	</form>
</body>
</html>